Collaborated with Adnan Jafferjee

For local threhold challenge problem, I wrote a script called LocalThreshold.m. 
For color map challenge problem, I wrote a script called ColorMap.m
I did not attempt line segment challenge
